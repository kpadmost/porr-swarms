...
public:
    ...
    Parameters(const std::function<float(const Position &)> &consFunction) : consFunction(consFunction), ro(0.4), // parameters from paper
                                                                                gamma(0.6), beta(0.08), neighbours(5),
                                                                                s(0.03), l0(5), t(0) {}
};
