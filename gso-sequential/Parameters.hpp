...
namespace gso {
    ...
    typedef std::function<float(const Position &, const float)> CostFunction;
    ...
    public:
        ...
        const std::function<float(const Position &, const float)> costFunction;

        Parameters(const std::function<float(const Position &, const float)> &consFunction, float rs,
        ...
        Parameters(
                const std::function<float(const Position &, const float)> &consFunction, float rs,
